...
from app.schemas.reservation import GuestRead, ReservationCreate, ReservationRead
from app.services import reservation_service, tenant_service

router = APIRouter()
front_desk_roles = (UserRole.PLATFORM_SUPER_ADMIN, UserRole.TENANT_ADMIN, UserRole.RECEPTIONIST, UserRole.OPERATIONS_STAFF)
