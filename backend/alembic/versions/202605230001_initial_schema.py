...
def upgrade() -> None:
    create_enum_if_not_exists("tenanttype", ("HOTEL", "RESORT", "AIRBNB_OPERATOR", "AIRPORT_LOUNGE", "HOSPITALITY_GROUP"))
    create_enum_if_not_exists(
        "userrole",
        ("PLATFORM_SUPER_ADMIN", "TENANT_ADMIN", "MANAGER", "RECEPTIONIST", "ACCOUNTANT", "OPERATIONS_STAFF"),
    )
    create_enum_if_not_exists("roomstatus", ("AVAILABLE", "OCCUPIED", "MAINTENANCE", "OUT_OF_SERVICE"))
    create_enum_if_not_exists(
        "reservationstatus",
    ...
    create_enum_if_not_exists(
        "analyticseventtype",
        ("RESERVATION_CREATED", "CHECK_IN", "CHECK_OUT", "PAYMENT_POSTED", "ROOM_MAINTENANCE"),
    )
    ...
    op.create_table(
        ...
        sa.Column("property_category", sa.String(length=120), nullable=True),
